...
u8_t hal_sleep (u8_t type, u32_t targettime);
 ...
 */
u8_t hal_getBattLevel (void);

/*
 * set current battery level
 */
void hal_setBattLevel (u8_t level);
...
u8_t* hal_joineui (void);
u8_t* hal_deveui (void);
u8_t* hal_nwkkey (void);
u8_t* hal_appkey (void);
u8_t* hal_serial (void);
u32_t  hal_region (void);
u32_t  hal_hwid (void);
u32_t  hal_unique (void);

u32_t hal_dnonce_next (void);
