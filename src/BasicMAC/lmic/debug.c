...
static int debug_itoa (char* buf, u32_t val, int base, int mindigits, int exp, int prec, char sign) {
            ...
            *dst++ = c;
            ...
            switch (c) {
                ...
                numeric: {
                        ...
                        u32_t val = longint ? va_arg(arg, long) : va_arg(arg, int);
